...
export const canisterId = process.env.BLOCKC_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./blockC_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the blockC_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./blockC_backend.did.js")._SERVICE>}
 */
export const blockC_backend = createActor(canisterId);
